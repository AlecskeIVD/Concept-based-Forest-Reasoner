...
import logging
from src.AWA.randomF import extractTensorValues
...
def extractAccuracyBestMainModelAWA():
    depth = 3
    memorySize = 50
    lr = 0.001/2
    ...
    # Final Test Accuracy: 0.6500 ± 0.0244 for best config: depth=3, memorySize=50, lr=0.0005, useDescendingLR=False
    model.printTrees()