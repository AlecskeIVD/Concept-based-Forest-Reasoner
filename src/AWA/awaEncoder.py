...
class AWAEncoder(pl.LightningModule):
    def __init__(self, output_dim=256):
        ...
        self.concept_encoder.fc = torch.nn.Linear(self.concept_encoder.fc.in_features, output_dim)
...
class AWAEmbeddingExtractor(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.concept_encoder = models.inception_v3(weights=models.Inception_V3_Weights.DEFAULT)
...
class AWALinearBackbone(pl.LightningModule):
