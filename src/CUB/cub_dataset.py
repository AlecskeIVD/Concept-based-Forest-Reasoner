...
Adapted from: https://github.com/daviddebot/CMR/blob/main/experiments/cub/CUB200/cub_loader.py
who adapted it from https://github.com/yewsiang/ConceptBottleneck/blob/master/CUB/cub_loader.py
"""
import os
import random
import torch
...
DATASET_DIR = "/Users/alecvandeuren/Thesis/src/data/raw/CUB/CUB_fixed/"
...
class CUBDataset(Dataset):
    ...
    def __init__(self, pkl_file_paths, use_attr, no_img, uncertain_label, image_dir, n_class_attr, root_dir='../data/CUB200/', path_transform=None, transform=None, concept_transform=None, label_transform=None):
        ...
        self.n_concepts = len(SELECTED_CONCEPTS)
